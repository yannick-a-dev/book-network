...
import com.esso.booknetwork.file.FileStorageService;
...
public class BookService {
    ...
    public PageResponse<BookResponse> findAllBooks(int page, int size, Authentication connectedUser) throws UnauthorizedAccessException {
        if (connectedUser == null || !connectedUser.isAuthenticated() || connectedUser instanceof AnonymousAuthenticationToken) {
    ...
    public Integer updateArchivedStatus(Integer bookId, Authentication connectedUser) {
        ...
        User user = (User) connectedUser.getPrincipal();
        if(!Objects.equals(book.getOwner().getId(),user.getId())){
            throw new OperationNotPermittedException("You can update books archived status");
        }
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        User user = ((User) connectedUser.getPrincipal());
        if(Objects.equals(book.getOwner().getId(),user.getId())){
            throw new OperationNotPermittedException("You can borrow your own book");
        }
